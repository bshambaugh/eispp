...
export default function DataOptionsSection({ onChange }) {
  ...
  const isNodeLink = selections.dataVisualization.value === "nodeLinkDiagram";

  return (
    <div className={styles.container}>
      <div className={styles.row}>
        <input type="checkbox" checked={selections.dataVisualization.enabled} onChange={() => toggleRow("dataVisualization")} />
        <div className={styles.options}>
          {["opm", "nodeLinkDiagram", "facetedBrowsing"].map((val) => (
            <label key={val} className={styles.radio}>
              ...
              {val === "nodeLinkDiagram" && isNodeLink && selections.dataVisualization.enabled && (
      ...
      <div className={styles.row}>
        <label className={styles.fullLabel}>
          <input type="checkbox" checked={selections.ontologyInstancesAndOntologies.enabled} onChange={() => toggleRow("ontologyInstancesAndOntologies")} />
          Ontology Instances & Ontologies
        </label>
      </div>

      <div className={styles.row}>
        <input type="checkbox" checked={selections.linkedData.enabled} onChange={() => toggleRow("linkedData")} />
        <LinkedDataDegreeInput value={selections.linkedData.degree} onChange={handleDegreeChange} />
      </div>

      <div className={styles.row}>
        <label className={styles.fullLabel}>
          <input type="checkbox" checked={selections.aiOutput.enabled} onChange={() => toggleRow("aiOutput")} />
